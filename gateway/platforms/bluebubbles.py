...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _record_sent_message(self, chat_id: str, text: str, result: SendResult) -> None:
    ...
    def format_message(self, content: str) -> str:
        # iMessage auto-links bare URLs; keep Markdown destinations in the same bubble.
    ...
    async def _handle_webhook(self, request):
        ...
        reply_to_id = self._value(record.get("threadOriginatorGuid"), record.get("associatedMessageGuid"))
        reply_to_text = rich_sent_store.lookup(session_chat_id, reply_to_id) if reply_to_id else None
        if message_id:
        ...
        event = MessageEvent(
            ...
            reply_to_is_own_message=reply_to_id in self._sent_guids if reply_to_id else False,
